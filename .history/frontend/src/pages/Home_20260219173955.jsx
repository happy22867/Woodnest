        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "40px" }}>
              ...
              <button onClick={handleLogout} style={{ padding: "12px 28px", background: "#ff4d4d",  color: "#fff", border: "none",  borderRadius: "10px", fontWeight: 700,fontSize: "17px", cursor: "pointer",
  }}
>
  Logout
</button>
