...
// Foggy dark forest cabin - blue/teal moody winter vibe, single house with pine trees
const BG = "https://images.unsplash.com/photo-1520208422220-d12a3c588574?w=1600&q=90";
...
const Home = () => {
  ...
  return (
    <div style={{
      ...
      {/* Outer border only — fully transparent */}
      <div style={{
        width: "88vw",
        height: "86vh",
        borderRadius: "26px",
        ...
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexShrink: 0 }}>
          ...
          {/* Booking card — dark frosted glass exactly like the zoomed image */}
          <div style={{
            width: "360px",
            ...
            <div style={{ display: "flex", gap: "10px", marginBottom: "20px" }}>
              {[{ label: "Check-in", val: "After 2:00 PM" }, { label: "Check-out", val: "Until 12:00 PM" }].map((c) => (
                <div key={c.label} style={{
                  ...
                  <div style={{ fontSize: "12px", color: "rgba(255,255,255,0.45)", marginBottom: "5px" }}>{c.label}</div>
