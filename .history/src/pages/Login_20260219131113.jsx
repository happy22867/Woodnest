...
// Dark moody rocky coastline - matches design exactly
...
const Login = () => {
  ...
  return (
    <div style={{
      ...
      {/* Outer blurred rounded container */}
      <div style={{
        width: "920px",
        borderRadius: "22px",
        overflow: "hidden",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "40px" }}>
          ...
          <div style={{ flex: 1, color: "#fff" }}>
            ...
            {/* TRAVEL with plane over the A */}
            <div style={{ position: "relative", display: "inline-block", marginBottom: "16px" }}>
              {/* small dashed path + plane above the A */}
              ...
              <span style={{
                ...
                TR<span style={{ position: "relative" }}>A</span>VEL
              </span>
            </div>

            {/* EXPLORE HORIZONS - condensed heavy font */}
            <h1 style={{
              fontSize: "68px",
              fontWeight: 900,
              lineHeight: 1.0,
              ...
              fontFamily: "'Arial Narrow', 'Impact', 'Franklin Gothic Medium', sans-serif",
              letterSpacing: "1px",
            }}>
              EXPLORE<br />HORIZONS
            </h1>
          ...
          <div style={{
            width: "340px",
            flexShrink: 0,
            background: "rgba(150,165,190,0.30)",
            backdropFilter: "blur(20px)",
            borderRadius: "16px",
            padding: "32px 28px",
          }}>

            <label style={{ display: "block", fontSize: "13px", color: "#fff", marginBottom: "7px", fontFamily: "'Arial', sans-serif" }}>Email</label>
            ...
            <label style={{ display: "block", fontSize: "13px", color: "#fff", marginBottom: "7px", fontFamily: "'Arial', sans-serif" }}>Password</label>
            ...
            <div style={{ textAlign: "right", marginBottom: "18px" }}>
              <a href="/forgot-password" style={{ fontSize: "13px", color: "#fff", textDecoration: "underline", fontFamily: "'Arial', sans-serif" }}>
                Forgot password?
              </a>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
              ...
              <span style={{ fontSize: "13px", color: "#fff", fontFamily: "'Arial', sans-serif" }}>or</span>
              <div style={{ flex: 1, height: "1px", background: "rgba(255,255,255,0.5)" }} />
            </div>
            ...
            <button style={{
              ...
              gap: "10px", marginBottom: "18px", fontFamily: "'Arial', sans-serif",
            }}>
            ...
            <p style={{ textAlign: "center", fontSize: "13px", color: "#fff", margin: 0, fontFamily: "'Arial', sans-serif" }}>
              Are you new?{" "}
